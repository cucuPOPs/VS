...
public abstract class UI_Base : MonoBehaviour
{
    ...
    protected void BindRT(Type type)
    {
    ...
    protected RectTransform GetRT(int idx)
    {
        return Get<RectTransform>(idx);
    }


    public static void BindEvent(GameObject go, Action action = null, Action<PointerEventData> dragAction = null,
